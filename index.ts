...
/* 
  editable conditions 
*/
export const gapMix = (value: Dimentions) => {
  return {
    "": value === "none",
    "gap-1": value === "xs",
    "gap-2": value === "sm",
...
export const paddingxMix = (value: Dimentions) => {
  return {
    "": value === "none",
    "px-2": value === "sm",
    "px-4": value === "md",
...
export const paddingyMix = (value: Dimentions) => {
  return {
    "": value === "none",
    "py-2": value === "sm",
    "py-4": value === "md",
...
export const paddingbMix = (value: Dimentions) => {
  return {
    "": value === "none",
    "pb-2": value === "sm",
    "pb-4": value === "md",
...
export const textSizeMix = (value: TextSize) => {
  return {
    "text-xs": value === "xs",
    "text-sm": value === "sm",
...
export const textWeightMix = (value: TextWeight) => {
  return {
...
export const textColorMix = (value: Color, active?: boolean) => {
  return {
...
/* todo: add active state color condition */
export const borderColorMix = (value: Color, active?: boolean) => {
  return {
...
export const textHoverColorMix = (value: Color) => {
  return {
...
export const bgMix = (value: Color) => {
  return {
...
export const roundedMix = (value: Rounded) => {
  return {
    rounded: value === "md",
    "rounded-lg": value === "lg",
...
export const shadowMix = (value: Shadow) => {
  return {
    shadow: value === "md",
    "shadow-lg": value === "lg",
